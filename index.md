...
- 解読、創案で使える
- 問題を数式的に因数分解する
- どの因子をどれだけ上げ下げすれば、のような定量的議論がしやすくなる

例:

- `利益 = (価格-コスト) * 数量`
    - 利益を上げるには？ → 価格を上げる、コストを下げる、数量を増やす等の議論が可能
- `シェア = 市場カバー率 * カバーしている市場における勝率`
    - シェアを 6% 上げるには？ → カバー率や勝率をどういじって上げるか、のバリエーションを提示して議論できる

### 🔨5: フレームワーク
- 解読、創案で使える
- 検討対象の全体像を捉えるための思考の枠組みのこと
- 色々あるので適宜使う
- 実用上は漏れがないとみなしていい

例: マッキンゼーの組織の 7S

- 🐰まとめるのだるいので割愛: [マッキンゼーが提唱する組織変革のフレームワーク「7S」 - Salesforceブログ](https://www.salesforce.com/jp/blog/7s-for-change-organization/)

### 🔨6: それとそれ以外
- 解読、創案、評価で使える
- 1～5 は漏れの無さを強化していたが、これだけでは上手くフィットしない → この 6: の出番
